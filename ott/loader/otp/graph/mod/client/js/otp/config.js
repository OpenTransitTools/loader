...
otp_consts = {
    ...
    hostname       : "",
    restService    : "otp_mod",
    solrService    : "//modbeta.trimet.org/ws/solrwrap/v0/solr/select",
    ...
    attribution    : 'Map data &copy; 2019 Oregon Metro and <a href="http://www.openstreetmap.org/" target="_blank">OpenStreetMap</a> and contributors.'
};
...
otp.config = {
     ...
     */
    siteName            : "MOD Single Agency OTP",
    siteDescription     : "MOD Single Agency OTP",
