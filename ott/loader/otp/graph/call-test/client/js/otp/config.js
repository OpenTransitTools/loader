...
otp_consts = {
    ...
    //solrService    : "//rj-dv-mapgeo01:5555/solr?q=4012%20SE%2017th%20Ave",
    solrService    : "//maps6.trimet.org/solrwrap/solr/select",
    ...
    modules : [
        {
            ...
            options:
            {
                ...
                mailables : [
                    ...
                    { name : 'Rte 42 Schedule (42-Denney/Hall)', largePrint: true },
